...
CREATE TABLE CAT_INSUMOS(
	ID_INSUMO SERIAL NOT NULL UNIQUE,
	NOMBRE_INSUMO VARCHAR(30),
	DESCRIPCION_INSUMO TEXT,
	PRIMARY KEY(ID_INSUMO)
);--no implementada
CREATE TABLE INVENTARIO_ARTICULOS_VENTA(
	ID_ID_ARTICULO_ARTICULO_VENTA SERIAL NOT NULL UNIQUE,
	ID_TIENDA INT,
	CANTIDAD INT,
	FECHA_ENTRADA DATE,
	FECHA_ACTUALIZACION DATE,
	PRIMARY KEY(ID_ID_ARTICULO_ARTICULO_VENTA),
	FOREIGN KEY (ID_TIENDA) REFERENCES CAT_TIENDAS(ID_TIENDA),
	FOREIGN KEY (ID_ID_ARTICULO_ARTICULO_VENTA) REFERENCES CAT_ARTICULOS_VENTA(ID_ARTICULO_VENTA)
);--no implementada